...
import net.aethyus.archeon.gui.LoreScrap6GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap6GUIGui;
...
public class LoreScrap6Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_6")
	public static final Item block = null;

	public LoreScrap6Item(ArcheonModElements instance) {
		super(instance, 406);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap6GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Faelite"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap6GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
