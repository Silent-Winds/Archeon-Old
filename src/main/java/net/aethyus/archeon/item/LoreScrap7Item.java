...
import net.aethyus.archeon.gui.LoreScrap7GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap7GUIGui;
...
public class LoreScrap7Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_7")
	public static final Item block = null;

	public LoreScrap7Item(ArcheonModElements instance) {
		super(instance, 394);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap7GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Fauna"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap7GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
