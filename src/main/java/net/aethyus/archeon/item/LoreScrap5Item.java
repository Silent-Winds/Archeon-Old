...
import net.aethyus.archeon.gui.LoreScrap5GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap5GUIGui;
...
public class LoreScrap5Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_5")
	public static final Item block = null;

	public LoreScrap5Item(ArcheonModElements instance) {
		super(instance, 476);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap5GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Culinary Arts"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap5GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
