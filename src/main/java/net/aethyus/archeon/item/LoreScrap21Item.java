...
import net.aethyus.archeon.gui.LoreScrap21GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap21GUIGui;
...
public class LoreScrap21Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_21")
	public static final Item block = null;

	public LoreScrap21Item(ArcheonModElements instance) {
		super(instance, 468);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap21GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77The Panopticon"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap21GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
