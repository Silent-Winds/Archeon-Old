...
import net.aethyus.archeon.gui.LoreScrap16GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap16GUIGui;
...
public class LoreScrap16Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_16")
	public static final Item block = null;

	public LoreScrap16Item(ArcheonModElements instance) {
		super(instance, 463);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap16GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Power of Exyriane"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap16GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
