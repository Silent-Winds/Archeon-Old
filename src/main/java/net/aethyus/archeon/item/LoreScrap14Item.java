...
import net.aethyus.archeon.gui.LoreScrap14GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap14GUIGui;
...
public class LoreScrap14Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_14")
	public static final Item block = null;

	public LoreScrap14Item(ArcheonModElements instance) {
		super(instance, 484);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap14GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Lusonyth"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap14GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
