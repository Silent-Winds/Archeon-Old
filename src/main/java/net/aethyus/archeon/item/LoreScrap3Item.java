...
import net.aethyus.archeon.gui.LoreScrap3GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap3GUIGui;
...
public class LoreScrap3Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_3")
	public static final Item block = null;

	public LoreScrap3Item(ArcheonModElements instance) {
		super(instance, 473);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap3GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Clementium"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap3GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
