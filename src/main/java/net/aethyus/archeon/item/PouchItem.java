...
import net.aethyus.archeon.gui.PouchGUIGuiWindow;
import net.aethyus.archeon.gui.PouchGUIGui;
...
public class PouchItem extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:pouch")
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PouchGUIGuiWindow) {
