...
import net.aethyus.archeon.gui.LoreScrap12GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap12GUIGui;
...
public class LoreScrap12Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_12")
	public static final Item block = null;

	public LoreScrap12Item(ArcheonModElements instance) {
		super(instance, 399);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap12GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Heart of Nature"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap12GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
