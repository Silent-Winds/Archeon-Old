...
import net.aethyus.archeon.gui.LoreScrap13GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap13GUIGui;
...
public class LoreScrap13Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_13")
	public static final Item block = null;

	public LoreScrap13Item(ArcheonModElements instance) {
		super(instance, 476);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap13GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Wood Types"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap13GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
