...
import net.aethyus.archeon.gui.LoreScrap22GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap22GUIGui;
...
public class LoreScrap22Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_22")
	public static final Item block = null;

	public LoreScrap22Item(ArcheonModElements instance) {
		super(instance, 492);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap22GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Tower of Atmosphere"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap22GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
