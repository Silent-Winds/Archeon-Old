...
import net.aethyus.archeon.gui.LoreScrap11GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap11GUIGui;
...
public class LoreScrap11Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_11")
	public static final Item block = null;

	public LoreScrap11Item(ArcheonModElements instance) {
		super(instance, 411);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap11GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Glass Confections"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap11GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
