...
import net.aethyus.archeon.gui.LoreScrap17GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap17GUIGui;
...
public class LoreScrap17Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_17")
	public static final Item block = null;

	public LoreScrap17Item(ArcheonModElements instance) {
		super(instance, 475);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap17GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Seashells"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap17GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
