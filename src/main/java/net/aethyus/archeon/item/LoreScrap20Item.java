...
import net.aethyus.archeon.procedures.LoreScrapSoundOpenProcedure;
import net.aethyus.archeon.itemgroup.ArcheonMiscItemGroup;
import net.aethyus.archeon.gui.LoreScrap20GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap20GUIGui;
...
public class LoreScrap20Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_20")
	public static final Item block = null;

	public LoreScrap20Item(ArcheonModElements instance) {
		super(instance, 467);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap20GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Sunstradiver and Snail"));
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Lore Scrap");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap20GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			LoreScrapSoundOpenProcedure.executeProcedure(Stream
