...
public class OrangeLycorisPetalItem extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:orange_lycoris_petal")
		...
		public ItemCustom() {
			super(new Item.Properties().group(ArcheonMiscItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(3).saturation(0.2f)
							...
							.build()));
			setRegistryName("orange_lycoris_petal");
		}
