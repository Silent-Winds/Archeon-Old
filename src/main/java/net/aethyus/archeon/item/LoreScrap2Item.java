...
import net.aethyus.archeon.gui.LoreScrap2GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap2GUIGui;
...
public class LoreScrap2Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_2")
	public static final Item block = null;

	public LoreScrap2Item(ArcheonModElements instance) {
		super(instance, 465);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap2GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Artifacts"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap2GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
