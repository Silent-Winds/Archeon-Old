...
import net.aethyus.archeon.gui.LoreScrap4GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap4GUIGui;
...
public class LoreScrap4Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_4")
	public static final Item block = null;

	public LoreScrap4Item(ArcheonModElements instance) {
		super(instance, 451);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap4GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Columns and Pots"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap4GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
