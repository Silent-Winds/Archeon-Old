...
import net.aethyus.archeon.gui.LoreScrap8GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap8GUIGui;
...
public class LoreScrap8Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_8")
	public static final Item block = null;

	public LoreScrap8Item(ArcheonModElements instance) {
		super(instance, 471);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap8GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Flora Alchemy - 1"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap8GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
