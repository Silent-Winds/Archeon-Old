...
import net.aethyus.archeon.gui.LoreScrap9GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap9GUIGui;
...
public class LoreScrap9Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_9")
	public static final Item block = null;

	public LoreScrap9Item(ArcheonModElements instance) {
		super(instance, 479);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap9GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Flora Alchemy - 2"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap9GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
