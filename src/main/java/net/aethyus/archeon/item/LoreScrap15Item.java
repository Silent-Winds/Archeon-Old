...
import net.aethyus.archeon.gui.LoreScrap15GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap15GUIGui;
...
public class LoreScrap15Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_15")
	public static final Item block = null;

	public LoreScrap15Item(ArcheonModElements instance) {
		super(instance, 460);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap15GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Pink Diamonds"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap15GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
