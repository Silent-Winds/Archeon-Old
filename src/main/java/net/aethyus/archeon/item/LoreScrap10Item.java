...
import net.aethyus.archeon.gui.LoreScrap10GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap10GUIGui;
...
public class LoreScrap10Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_10")
	public static final Item block = null;

	public LoreScrap10Item(ArcheonModElements instance) {
		super(instance, 455);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap10GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Fruits"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap10GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
