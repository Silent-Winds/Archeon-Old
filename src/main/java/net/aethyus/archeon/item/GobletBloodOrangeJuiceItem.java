...
public class GobletBloodOrangeJuiceItem extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:goblet_blood_orange_juice")
		...
		public ItemCustom() {
			super(new Item.Properties().group(ArcheonMiscItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0.5f)
							...
							.build()));
			setRegistryName("goblet_blood_orange_juice");
		}
