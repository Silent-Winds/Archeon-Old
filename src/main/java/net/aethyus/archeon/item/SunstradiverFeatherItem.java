...
public class SunstradiverFeatherItem extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:sunstradiver_feather")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sunstradiver_feather");
		}
