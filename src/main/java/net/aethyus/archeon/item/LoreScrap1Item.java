...
import net.aethyus.archeon.gui.LoreScrap1GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap1GUIGui;
...
public class LoreScrap1Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_1")
	public static final Item block = null;

	public LoreScrap1Item(ArcheonModElements instance) {
		super(instance, 448);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap1GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Archeology"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap1GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
