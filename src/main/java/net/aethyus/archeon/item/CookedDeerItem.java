...
public class CookedDeerItem extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cooked_deer")
	public static final Item block = null;

	public CookedDeerItem(ArcheonModElements instance) {
		super(instance, 430);
	}
