...
import net.aethyus.archeon.gui.LoreScrap18GUIGuiWindow;
import net.aethyus.archeon.gui.LoreScrap18GUIGui;
...
public class LoreScrap18Item extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lore_scrap_18")
	public static final Item block = null;

	public LoreScrap18Item(ArcheonModElements instance) {
		super(instance, 463);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LoreScrap18GUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Stones Types - 1"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LoreScrap18GUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
