...
public class CeramicBricksSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ceramic_bricks_slab")
	public static final Block block = null;

	public CeramicBricksSlabBlock(ArcheonModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ceramic_bricks_slab");
		}
