...
public class PalmTrapdoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:palm_trapdoor")
	public static final Block block = null;

	public PalmTrapdoorBlock(ArcheonModElements instance) {
		super(instance, 19);
	}
