...
public class CypressSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cypress_slab")
	public static final Block block = null;

	public CypressSlabBlock(ArcheonModElements instance) {
		super(instance, 36);
	}
