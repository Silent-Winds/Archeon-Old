...
public class TropicstoneSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_slab")
	public static final Block block = null;

	public TropicstoneSlabBlock(ArcheonModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_slab");
		}
