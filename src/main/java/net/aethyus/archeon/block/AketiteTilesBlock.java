...
public class AketiteTilesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_tiles")
	public static final Block block = null;

	public AketiteTilesBlock(ArcheonModElements instance) {
		super(instance, 114);
	}
