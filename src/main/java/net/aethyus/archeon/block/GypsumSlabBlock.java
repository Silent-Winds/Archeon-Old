...
public class GypsumSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_slab")
	public static final Block block = null;

	public GypsumSlabBlock(ArcheonModElements instance) {
		super(instance, 179);
	}
