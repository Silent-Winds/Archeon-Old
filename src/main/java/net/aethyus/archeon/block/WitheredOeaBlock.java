...
public class WitheredOeaBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:withered_oea")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("withered_oea"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:withered_oea"), configuredFeature);
		}
	}
