...
public class CobbledAketiteWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cobbled_aketite_wall")
	public static final Block block = null;

	public CobbledAketiteWallBlock(ArcheonModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cobbled_aketite_wall");
		}
