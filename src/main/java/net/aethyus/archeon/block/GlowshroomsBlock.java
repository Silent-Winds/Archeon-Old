...
import net.aethyus.archeon.procedures.GlowshroomsUpdateTickProcedure;
...
public class GlowshroomsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:glowshrooms")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glowshrooms"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:glowshrooms"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == CaveMyceliumBlock.block || ground == CaveMyceliumBlockBlock.block || ground == TropicstoneBlock.block
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			GlowshroomsUpdateTickProcedure.executeProcedure(Stream
