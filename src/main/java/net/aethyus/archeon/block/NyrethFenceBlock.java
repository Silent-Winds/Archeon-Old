...
public class NyrethFenceBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_fence")
	public static final Block block = null;

	public NyrethFenceBlock(ArcheonModElements instance) {
		super(instance, 1131);
	}
