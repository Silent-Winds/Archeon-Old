...
public class MossyTropicstoneBricksStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_tropicstone_bricks_stairs")
	public static final Block block = null;

	public MossyTropicstoneBricksStairsBlock(ArcheonModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_tropicstone_bricks_stairs");
		}
