...
public class MossyTropicstoneCobblestoneWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_tropicstone_cobblestone_wall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_tropicstone_cobblestone_wall");
		}
