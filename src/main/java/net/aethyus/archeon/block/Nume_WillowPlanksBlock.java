...
public class Nume_WillowPlanksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_planks")
	public static final Block block = null;

	public Nume_WillowPlanksBlock(ArcheonModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nume_willow_planks");
		}
