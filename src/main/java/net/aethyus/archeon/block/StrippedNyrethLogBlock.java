...
public class StrippedNyrethLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_nyreth_log")
	public static final Block block = null;

	public StrippedNyrethLogBlock(ArcheonModElements instance) {
		super(instance, 1151);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_nyreth_log");
		}
