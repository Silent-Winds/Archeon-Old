...
public class DuneSandGlassTilesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_tiles")
	public static final Block block = null;

	public DuneSandGlassTilesBlock(ArcheonModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_tiles");
		}
