...
public class OrnateArtemnite1Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ornate_artemnite_1")
	public static final Block block = null;

	public OrnateArtemnite1Block(ArcheonModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ornate_artemnite_1");
		}
