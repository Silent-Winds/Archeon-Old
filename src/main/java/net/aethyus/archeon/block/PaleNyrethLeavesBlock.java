...
public class PaleNyrethLeavesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:pale_nyreth_leaves")
	public static final Block block = null;

	public PaleNyrethLeavesBlock(ArcheonModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pale_nyreth_leaves");
		}
