...
public class ArtemniteTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_tiles_stairs")
	public static final Block block = null;

	public ArtemniteTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("artemnite_tiles_stairs");
		}
