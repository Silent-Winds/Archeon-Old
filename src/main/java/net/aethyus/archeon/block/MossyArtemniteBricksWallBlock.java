...
public class MossyArtemniteBricksWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_artemnite_bricks_wall")
	public static final Block block = null;

	public MossyArtemniteBricksWallBlock(ArcheonModElements instance) {
		super(instance, 160);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_artemnite_bricks_wall");
		}
