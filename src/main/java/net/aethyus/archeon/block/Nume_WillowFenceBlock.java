...
public class Nume_WillowFenceBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_fence")
	public static final Block block = null;

	public Nume_WillowFenceBlock(ArcheonModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("nume_willow_fence");
		}
