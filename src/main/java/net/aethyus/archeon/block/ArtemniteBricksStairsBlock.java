...
public class ArtemniteBricksStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_bricks_stairs")
	public static final Block block = null;

	public ArtemniteBricksStairsBlock(ArcheonModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("artemnite_bricks_stairs");
		}
