...
public class NyrethDoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_door")
	public static final Block block = null;

	public NyrethDoorBlock(ArcheonModElements instance) {
		super(instance, 76);
	}
