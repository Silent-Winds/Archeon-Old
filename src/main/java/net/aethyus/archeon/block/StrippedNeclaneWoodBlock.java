...
public class StrippedNeclaneWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_neclane_wood")
	public static final Block block = null;

	public StrippedNeclaneWoodBlock(ArcheonModElements instance) {
		super(instance, 184);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_neclane_wood");
		}
