...
public class Nume_WillowButtonBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_button")
	public static final Block block = null;

	public Nume_WillowButtonBlock(ArcheonModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("nume_willow_button");
		}
