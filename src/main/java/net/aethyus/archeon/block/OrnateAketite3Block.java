...
public class OrnateAketite3Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ornate_aketite_3")
	public static final Block block = null;

	public OrnateAketite3Block(ArcheonModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ornate_aketite_3");
		}
