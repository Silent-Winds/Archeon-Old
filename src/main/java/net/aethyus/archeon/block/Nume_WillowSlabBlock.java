...
public class Nume_WillowSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_slab")
	public static final Block block = null;

	public Nume_WillowSlabBlock(ArcheonModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("nume_willow_slab");
		}
