...
public class WitheredArgandeaneBlossomBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:withered_argandeane_blossom")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("withered_argandeane_blossom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:withered_argandeane_blossom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("withered_argandeane_blossom");
		}
