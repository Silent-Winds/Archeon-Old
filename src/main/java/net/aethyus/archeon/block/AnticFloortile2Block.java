...
public class AnticFloortile2Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antic_floortile_2")
	public static final Block block = null;

	public AnticFloortile2Block(ArcheonModElements instance) {
		super(instance, 238);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("antic_floortile_2");
		}
