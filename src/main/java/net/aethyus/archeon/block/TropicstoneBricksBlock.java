...
public class TropicstoneBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_bricks")
	public static final Block block = null;

	public TropicstoneBricksBlock(ArcheonModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_bricks");
		}
