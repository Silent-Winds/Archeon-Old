...
public class FancyArtemniteTilesWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:fancy_artemnite_tiles_wall")
	public static final Block block = null;

	public FancyArtemniteTilesWallBlock(ArcheonModElements instance) {
		super(instance, 165);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("fancy_artemnite_tiles_wall");
		}
