...
public class SmoothTropicstoneBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:smooth_tropicstone")
	public static final Block block = null;

	public SmoothTropicstoneBlock(ArcheonModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_tropicstone");
		}
