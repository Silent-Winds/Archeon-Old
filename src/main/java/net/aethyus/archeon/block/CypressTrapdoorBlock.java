...
public class CypressTrapdoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cypress_trapdoor")
	public static final Block block = null;

	public CypressTrapdoorBlock(ArcheonModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("cypress_trapdoor");
		}
