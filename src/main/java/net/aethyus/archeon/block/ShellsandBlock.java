...
public class ShellsandBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:shellsand")
	public static final Block block = null;

	public ShellsandBlock(ArcheonModElements instance) {
		super(instance, 4);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("archeon:shellsand_match"), () -> CustomRuleTest.codec);
