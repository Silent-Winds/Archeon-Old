...
public class SouthstoneEmeraldOreBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:southstone_emerald_ore")
	public static final Block block = null;

	public SouthstoneEmeraldOreBlock(ArcheonModElements instance) {
		super(instance, 93);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("southstone_emerald_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("archeon:southstone_emerald_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("southstone_emerald_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:southstone_emerald_ore"), configuredFeature);
		}
	}
