...
public class NyrethTrapdoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_trapdoor")
	public static final Block block = null;

	public NyrethTrapdoorBlock(ArcheonModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("nyreth_trapdoor");
		}
