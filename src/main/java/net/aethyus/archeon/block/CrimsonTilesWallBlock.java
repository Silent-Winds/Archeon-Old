...
public class CrimsonTilesWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:crimson_tiles_wall")
	public static final Block block = null;

	public CrimsonTilesWallBlock(ArcheonModElements instance) {
		super(instance, 267);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_tiles_wall");
		}
