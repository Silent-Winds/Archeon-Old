...
public class NumeWillowDoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_door")
	public static final Block block = null;

	public NumeWillowDoorBlock(ArcheonModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("nume_willow_door");
		}
