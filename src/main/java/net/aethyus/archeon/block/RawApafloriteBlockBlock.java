...
public class RawApafloriteBlockBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:raw_apaflorite_block")
	public static final Block block = null;

	public RawApafloriteBlockBlock(ArcheonModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("raw_apaflorite_block");
		}
