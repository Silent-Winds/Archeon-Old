...
public class MossyTropicstoneBricksWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_tropicstone_bricks_wall")
	public static final Block block = null;

	public MossyTropicstoneBricksWallBlock(ArcheonModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_tropicstone_bricks_wall");
		}
