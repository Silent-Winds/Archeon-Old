...
public class DuneSandGlassPaneTilesTopRightBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_pane_tiles_top_right")
	public static final Block block = null;

	public DuneSandGlassPaneTilesTopRightBlock(ArcheonModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_pane_tiles_top_right");
		}
