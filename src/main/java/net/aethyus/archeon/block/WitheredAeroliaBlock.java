...
public class WitheredAeroliaBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:withered_aerolia")
	public static final Block block = null;

	public WitheredAeroliaBlock(ArcheonModElements instance) {
		super(instance, 221);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("withered_aerolia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:withered_aerolia"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("withered_aerolia");
		}
