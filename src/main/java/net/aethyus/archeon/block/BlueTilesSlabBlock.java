...
public class BlueTilesSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:blue_tiles_slab")
	public static final Block block = null;

	public BlueTilesSlabBlock(ArcheonModElements instance) {
		super(instance, 278);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_tiles_slab");
		}
