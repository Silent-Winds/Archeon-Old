...
public class NyrethLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_log")
	public static final Block block = null;

	public NyrethLogBlock(ArcheonModElements instance) {
		super(instance, 68);
	}
