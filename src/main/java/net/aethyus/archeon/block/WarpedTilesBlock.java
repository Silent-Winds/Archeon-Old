...
public class WarpedTilesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:warped_tiles")
	public static final Block block = null;

	public WarpedTilesBlock(ArcheonModElements instance) {
		super(instance, 264);
	}
