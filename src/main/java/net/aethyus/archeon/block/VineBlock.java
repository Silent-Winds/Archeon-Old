...
public class VineBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vine")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("vine"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:vine"), configuredFeature);
		}
	}
