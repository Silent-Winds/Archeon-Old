...
public class TropicstoneStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_stairs")
	public static final Block block = null;

	public TropicstoneStairsBlock(ArcheonModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_stairs");
		}
