...
public class StrippedNumeWillowWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_nume_willow_wood")
	public static final Block block = null;

	public StrippedNumeWillowWoodBlock(ArcheonModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_nume_willow_wood");
		}
