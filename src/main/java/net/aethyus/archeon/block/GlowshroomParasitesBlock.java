...
public class GlowshroomParasitesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:glowshroom_parasites")
	public static final Block block = null;

	public GlowshroomParasitesBlock(ArcheonModElements instance) {
		super(instance, 339);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glowshroom_parasites"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:glowshroom_parasites"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("glowshroom_parasites");
		}
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == CaveMyceliumBlock.block || ground == CaveMyceliumBlockBlock.block
