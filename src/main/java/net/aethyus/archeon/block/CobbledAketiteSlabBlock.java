...
public class CobbledAketiteSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cobbled_aketite_slab")
	public static final Block block = null;

	public CobbledAketiteSlabBlock(ArcheonModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cobbled_aketite_slab");
		}
