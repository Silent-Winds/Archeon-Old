...
public class CrimsonTilesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:crimson_tiles")
	public static final Block block = null;

	public CrimsonTilesBlock(ArcheonModElements instance) {
		super(instance, 264);
	}
