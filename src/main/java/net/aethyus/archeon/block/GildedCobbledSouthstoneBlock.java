...
public class GildedCobbledSouthstoneBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gilded_cobbled_southstone")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gilded_cobbled_southstone");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("archeon:gilded_cobbled_southstone_match"),
			...
			event.getRegistry().register(feature.setRegistryName("gilded_cobbled_southstone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:gilded_cobbled_southstone"), configuredFeature);
		}
	}
