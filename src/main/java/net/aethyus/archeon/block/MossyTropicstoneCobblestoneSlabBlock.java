...
public class MossyTropicstoneCobblestoneSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_tropicstone_cobblestone_slab")
	public static final Block block = null;

	public MossyTropicstoneCobblestoneSlabBlock(ArcheonModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_tropicstone_cobblestone_slab");
		}
