...
public class DuneSandGlassBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass")
	public static final Block block = null;

	public DuneSandGlassBlock(ArcheonModElements instance) {
		super(instance, 257);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass");
		}
