...
public class AketiteTilesWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_tiles_wall")
	public static final Block block = null;

	public AketiteTilesWallBlock(ArcheonModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("aketite_tiles_wall");
		}
