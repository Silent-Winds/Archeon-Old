...
public class WetDirtBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:wet_dirt")
	public static final Block block = null;

	public WetDirtBlock(ArcheonModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("archeon:wet_dirt_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("wet_dirt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:wet_dirt"), configuredFeature);
		}
	}
