...
public class GypsumBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_bricks")
	public static final Block block = null;

	public GypsumBricksBlock(ArcheonModElements instance) {
		super(instance, 251);
	}
