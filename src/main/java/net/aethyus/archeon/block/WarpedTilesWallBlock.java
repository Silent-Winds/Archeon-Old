...
public class WarpedTilesWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:warped_tiles_wall")
	public static final Block block = null;

	public WarpedTilesWallBlock(ArcheonModElements instance) {
		super(instance, 265);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_tiles_wall");
		}
