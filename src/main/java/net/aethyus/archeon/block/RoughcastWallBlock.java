...
public class RoughcastWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:roughcast_wall")
	public static final Block block = null;

	public RoughcastWallBlock(ArcheonModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("roughcast_wall");
		}
