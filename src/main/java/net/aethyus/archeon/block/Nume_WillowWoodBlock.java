...
public class Nume_WillowWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_wood")
	public static final Block block = null;

	public Nume_WillowWoodBlock(ArcheonModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("nume_willow_wood");
		}
