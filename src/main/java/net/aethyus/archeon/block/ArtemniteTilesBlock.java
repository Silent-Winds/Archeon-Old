...
public class ArtemniteTilesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_tiles")
	public static final Block block = null;

	public ArtemniteTilesBlock(ArcheonModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("artemnite_tiles");
		}
