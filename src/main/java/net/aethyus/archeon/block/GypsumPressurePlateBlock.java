...
public class GypsumPressurePlateBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_pressure_plate");
		}
