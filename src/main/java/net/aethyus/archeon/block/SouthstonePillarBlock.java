...
public class SouthstonePillarBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:southstone_pillar")
	public static final Block block = null;

	public SouthstonePillarBlock(ArcheonModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("southstone_pillar");
		}
