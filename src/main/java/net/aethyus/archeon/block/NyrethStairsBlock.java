...
public class NyrethStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_stairs")
	public static final Block block = null;

	public NyrethStairsBlock(ArcheonModElements instance) {
		super(instance, 1129);
	}
