...
public class CypressFenceBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cypress_fence")
	public static final Block block = null;

	public CypressFenceBlock(ArcheonModElements instance) {
		super(instance, 39);
	}
