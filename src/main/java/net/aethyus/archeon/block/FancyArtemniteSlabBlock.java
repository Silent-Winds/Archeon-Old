...
public class FancyArtemniteSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:fancy_artemnite_slab")
	public static final Block block = null;

	public FancyArtemniteSlabBlock(ArcheonModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("fancy_artemnite_slab");
		}
