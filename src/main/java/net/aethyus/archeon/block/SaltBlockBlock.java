...
public class SaltBlockBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:salt_block")
	public static final Block block = null;

	public SaltBlockBlock(ArcheonModElements instance) {
		super(instance, 5);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("archeon:salt_block_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("salt_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:salt_block"), configuredFeature);
		}
	}
