...
public class AnticFloortileSlab2Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antic_floortile_slab_2")
	public static final Block block = null;

	public AnticFloortileSlab2Block(ArcheonModElements instance) {
		super(instance, 241);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("antic_floortile_slab_2");
		}
