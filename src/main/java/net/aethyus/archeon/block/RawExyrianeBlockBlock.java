...
public class RawExyrianeBlockBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:raw_exyriane_block")
	public static final Block block = null;

	public RawExyrianeBlockBlock(ArcheonModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("raw_exyriane_block");
		}
