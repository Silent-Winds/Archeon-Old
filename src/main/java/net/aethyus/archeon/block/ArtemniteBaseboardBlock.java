...
public class ArtemniteBaseboardBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_baseboard")
	public static final Block block = null;

	public ArtemniteBaseboardBlock(ArcheonModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("artemnite_baseboard");
		}
