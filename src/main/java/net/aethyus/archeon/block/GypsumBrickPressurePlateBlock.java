...
public class GypsumBrickPressurePlateBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_brick_pressure_plate")
	public static final Block block = null;

	public GypsumBrickPressurePlateBlock(ArcheonModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_brick_pressure_plate");
		}
