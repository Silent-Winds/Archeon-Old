...
public class GreenTilesWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:green_tiles_wall")
	public static final Block block = null;

	public GreenTilesWallBlock(ArcheonModElements instance) {
		super(instance, 297);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("green_tiles_wall");
		}
