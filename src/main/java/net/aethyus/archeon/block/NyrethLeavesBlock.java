...
public class NyrethLeavesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_leaves")
	public static final Block block = null;

	public NyrethLeavesBlock(ArcheonModElements instance) {
		super(instance, 194);
	}
