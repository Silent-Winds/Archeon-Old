...
import net.aethyus.archeon.procedures.VinePlantDestroyedByPlayerProcedure;
...
public class BloodOrangeBushBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:blood_orange_bush")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blood_orange_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:blood_orange_bush"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("blood_orange_bush");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			VinePlantDestroyedByPlayerProcedure.executeProcedure(Stream
