...
public class VuxanciaStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vuxancia_stairs")
	public static final Block block = null;

	public VuxanciaStairsBlock(ArcheonModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("vuxancia_stairs");
		}
