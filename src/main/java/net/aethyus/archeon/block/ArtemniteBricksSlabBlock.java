...
public class ArtemniteBricksSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_bricks_slab")
	public static final Block block = null;

	public ArtemniteBricksSlabBlock(ArcheonModElements instance) {
		super(instance, 149);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("artemnite_bricks_slab");
		}
