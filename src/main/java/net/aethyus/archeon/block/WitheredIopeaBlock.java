...
public class WitheredIopeaBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:withered_iopea")
	public static final Block block = null;

	public WitheredIopeaBlock(ArcheonModElements instance) {
		super(instance, 308);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("withered_iopea"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:withered_iopea"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("withered_iopea");
		}
