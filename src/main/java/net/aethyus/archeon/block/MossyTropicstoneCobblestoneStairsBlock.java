...
public class MossyTropicstoneCobblestoneStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_tropicstone_cobblestone_stairs")
	public static final Block block = null;

	public MossyTropicstoneCobblestoneStairsBlock(ArcheonModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_tropicstone_cobblestone_stairs");
		}
