...
public class TropicstoneCobblestoneWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_cobblestone_wall")
	public static final Block block = null;

	public TropicstoneCobblestoneWallBlock(ArcheonModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_cobblestone_wall");
		}
