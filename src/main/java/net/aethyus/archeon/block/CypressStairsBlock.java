...
public class CypressStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cypress_stairs")
	public static final Block block = null;

	public CypressStairsBlock(ArcheonModElements instance) {
		super(instance, 37);
	}
