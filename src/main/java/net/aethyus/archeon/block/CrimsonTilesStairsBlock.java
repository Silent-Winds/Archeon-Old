...
public class CrimsonTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:crimson_tiles_stairs")
	public static final Block block = null;

	public CrimsonTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_tiles_stairs");
		}
