...
public class TallWetFernBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tall_wet_fern")
	public static final Block block = null;

	public TallWetFernBlock(ArcheonModElements instance) {
		super(instance, 284);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tall_wet_fern"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:tall_wet_fern"), configuredFeature);
		}
	}
