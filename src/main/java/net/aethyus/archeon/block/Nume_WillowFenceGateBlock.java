...
public class Nume_WillowFenceGateBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_fence_gate")
	public static final Block block = null;

	public Nume_WillowFenceGateBlock(ArcheonModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("nume_willow_fence_gate");
		}
