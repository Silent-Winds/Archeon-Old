...
public class MossyTropicstoneCobblestoneBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_tropicstone_cobblestone")
	public static final Block block = null;

	public MossyTropicstoneCobblestoneBlock(ArcheonModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_tropicstone_cobblestone");
		}
