...
public class SummerAntropyDoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:summer_antropy_door")
	public static final Block block = null;

	public SummerAntropyDoorBlock(ArcheonModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("summer_antropy_door");
		}
