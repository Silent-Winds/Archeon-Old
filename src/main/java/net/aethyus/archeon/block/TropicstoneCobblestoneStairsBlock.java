...
public class TropicstoneCobblestoneStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_cobblestone_stairs")
	public static final Block block = null;

	public TropicstoneCobblestoneStairsBlock(ArcheonModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_cobblestone_stairs");
		}
