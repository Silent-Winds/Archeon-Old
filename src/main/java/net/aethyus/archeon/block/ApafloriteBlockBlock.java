...
public class ApafloriteBlockBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:apaflorite_block")
	public static final Block block = null;

	public ApafloriteBlockBlock(ArcheonModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("apaflorite_block");
		}
