...
public class DuneSandGlassTilesBottomRightBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_tiles_bottom_right")
	public static final Block block = null;

	public DuneSandGlassTilesBottomRightBlock(ArcheonModElements instance) {
		super(instance, 255);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_tiles_bottom_right");
		}
