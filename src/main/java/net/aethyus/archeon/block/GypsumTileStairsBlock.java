...
public class GypsumTileStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_tile_stairs")
	public static final Block block = null;

	public GypsumTileStairsBlock(ArcheonModElements instance) {
		super(instance, 1311);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_tile_stairs");
		}
