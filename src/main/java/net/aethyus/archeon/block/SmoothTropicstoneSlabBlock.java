...
public class SmoothTropicstoneSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:smooth_tropicstone_slab")
	public static final Block block = null;

	public SmoothTropicstoneSlabBlock(ArcheonModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tropicstone_slab");
		}
