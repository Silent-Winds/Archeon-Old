...
public class CraqueledArtemniteBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:craqueled_artemnite_bricks")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("craqueled_artemnite_bricks");
		}
