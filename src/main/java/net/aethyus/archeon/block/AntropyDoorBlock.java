...
public class AntropyDoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antropy_door")
	public static final Block block = null;

	public AntropyDoorBlock(ArcheonModElements instance) {
		super(instance, 30);
	}
