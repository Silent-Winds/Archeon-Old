...
public class GypsumBricksStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_bricks_stairs")
	public static final Block block = null;

	public GypsumBricksStairsBlock(ArcheonModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_bricks_stairs");
		}
