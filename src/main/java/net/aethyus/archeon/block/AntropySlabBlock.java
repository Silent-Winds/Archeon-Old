...
public class AntropySlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antropy_slab")
	public static final Block block = null;

	public AntropySlabBlock(ArcheonModElements instance) {
		super(instance, 24);
	}
