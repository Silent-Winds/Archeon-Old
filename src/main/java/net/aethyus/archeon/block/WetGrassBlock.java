...
public class WetGrassBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:wet_grass")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("wet_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:wet_grass"), configuredFeature);
		}
	}
