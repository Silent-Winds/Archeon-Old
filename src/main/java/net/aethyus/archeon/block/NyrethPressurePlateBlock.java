...
public class NyrethPressurePlateBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_pressure_plate")
	public static final Block block = null;

	public NyrethPressurePlateBlock(ArcheonModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("nyreth_pressure_plate");
		}
