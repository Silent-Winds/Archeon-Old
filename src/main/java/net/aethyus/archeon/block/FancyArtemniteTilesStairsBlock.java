...
public class FancyArtemniteTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:fancy_artemnite_tiles_stairs")
	public static final Block block = null;

	public FancyArtemniteTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 168);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("fancy_artemnite_tiles_stairs");
		}
