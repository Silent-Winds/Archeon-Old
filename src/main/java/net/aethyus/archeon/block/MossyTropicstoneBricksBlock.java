...
public class MossyTropicstoneBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_tropicstone_bricks")
	public static final Block block = null;

	public MossyTropicstoneBricksBlock(ArcheonModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_tropicstone_bricks");
		}
