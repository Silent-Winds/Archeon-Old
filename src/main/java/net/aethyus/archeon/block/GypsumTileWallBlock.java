...
public class GypsumTileWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_tile_wall")
	public static final Block block = null;

	public GypsumTileWallBlock(ArcheonModElements instance) {
		super(instance, 1313);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_tile_wall");
		}
