...
public class CattailsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cattails")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cattails"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:cattails"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == WetGrassBlockBlock.block || ground == WetDirtBlock.block || ground == Blocks.GRASS_BLOCK || ground == Blocks.DIRT
					|| ground == SandySoilBlock.block || ground == TropicstoneCobblestoneBlock.block
					|| ground == MossyTropicstoneCobblestoneBlock.block
