...
public class CeramicSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ceramic_slab")
	public static final Block block = null;

	public CeramicSlabBlock(ArcheonModElements instance) {
		super(instance, 185);
	}
