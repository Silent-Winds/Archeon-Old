...
public class GlowsproutsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:glowsprouts")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glowsprouts"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:glowsprouts"), configuredFeature);
		}
	}
