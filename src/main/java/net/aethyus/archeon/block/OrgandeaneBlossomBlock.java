...
public class OrgandeaneBlossomBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:organdeane_blossom")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("organdeane_blossom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:organdeane_blossom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("organdeane_blossom");
		}
