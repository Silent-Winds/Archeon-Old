...
public class GypsumBricksWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_bricks_wall")
	public static final Block block = null;

	public GypsumBricksWallBlock(ArcheonModElements instance) {
		super(instance, 242);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_bricks_wall");
		}
