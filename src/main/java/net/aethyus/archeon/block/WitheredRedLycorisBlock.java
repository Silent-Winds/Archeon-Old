...
public class WitheredRedLycorisBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:withered_red_lycoris")
	public static final Block block = null;

	public WitheredRedLycorisBlock(ArcheonModElements instance) {
		super(instance, 185);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("withered_red_lycoris"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:withered_red_lycoris"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("withered_red_lycoris");
		}
