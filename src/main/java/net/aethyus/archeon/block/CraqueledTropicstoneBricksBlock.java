...
public class CraqueledTropicstoneBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:craqueled_tropicstone_bricks")
	public static final Block block = null;

	public CraqueledTropicstoneBricksBlock(ArcheonModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("craqueled_tropicstone_bricks");
		}
