...
public class DuneSandGlassPaneTilesTopLeftBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_pane_tiles_top_left")
	public static final Block block = null;

	public DuneSandGlassPaneTilesTopLeftBlock(ArcheonModElements instance) {
		super(instance, 170);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_pane_tiles_top_left");
		}
