...
public class CeramicBricksStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ceramic_bricks_stairs")
	public static final Block block = null;

	public CeramicBricksStairsBlock(ArcheonModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.BONE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.BONE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(1)
							.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("ceramic_bricks_stairs");
		}
