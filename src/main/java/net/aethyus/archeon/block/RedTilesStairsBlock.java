...
public class RedTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:red_tiles_stairs")
	public static final Block block = null;

	public RedTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_tiles_stairs");
		}
