...
public class OchreTilesSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ochre_tiles_slab")
	public static final Block block = null;

	public OchreTilesSlabBlock(ArcheonModElements instance) {
		super(instance, 243);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ochre_tiles_slab");
		}
