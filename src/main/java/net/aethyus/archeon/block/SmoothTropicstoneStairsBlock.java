...
public class SmoothTropicstoneStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:smooth_tropicstone_stairs")
	public static final Block block = null;

	public SmoothTropicstoneStairsBlock(ArcheonModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_tropicstone_stairs");
		}
