...
public class StrippedNyrethWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_nyreth_wood")
	public static final Block block = null;

	public StrippedNyrethWoodBlock(ArcheonModElements instance) {
		super(instance, 185);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_nyreth_wood");
		}
