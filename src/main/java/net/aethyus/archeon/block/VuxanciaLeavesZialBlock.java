...
public class VuxanciaLeavesZialBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vuxancia_leaves_zial")
	public static final Block block = null;

	public VuxanciaLeavesZialBlock(ArcheonModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vuxancia_leaves_zial");
		}
