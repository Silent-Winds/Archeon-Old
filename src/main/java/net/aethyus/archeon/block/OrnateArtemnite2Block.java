...
public class OrnateArtemnite2Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ornate_artemnite_2")
	public static final Block block = null;

	public OrnateArtemnite2Block(ArcheonModElements instance) {
		super(instance, 167);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ornate_artemnite_2");
		}
