...
public class TropicalSandBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropical_sand")
	public static final Block block = null;

	public TropicalSandBlock(ArcheonModElements instance) {
		super(instance, 3);
	}
