...
public class TallWetGrassBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tall_wet_grass")
	public static final Block block = null;

	public TallWetGrassBlock(ArcheonModElements instance) {
		super(instance, 332);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new TallBlockItem(block, new Item.Properties().group(ArcheonFaunaItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tall_wet_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:tall_wet_grass"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("tall_wet_grass");
		}
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == WetDirtBlock.block || ground == WetGrassBlockBlock.block || ground == Blocks.GRASS_BLOCK || ground == Blocks.DIRT
					|| ground == HollowCypressLogBlock.block || ground == CypressLogBlock.block || ground == CypressWoodBlock.block
