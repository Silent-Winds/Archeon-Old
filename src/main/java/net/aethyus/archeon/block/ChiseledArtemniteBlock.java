...
public class ChiseledArtemniteBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:chiseled_artemnite")
	public static final Block block = null;

	public ChiseledArtemniteBlock(ArcheonModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_artemnite");
		}
