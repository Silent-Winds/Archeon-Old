...
public class AketiteTilesSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_tiles_slab")
	public static final Block block = null;

	public AketiteTilesSlabBlock(ArcheonModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("aketite_tiles_slab");
		}
