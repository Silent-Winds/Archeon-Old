...
public class AketiteTileBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_tile")
	public static final Block block = null;

	public AketiteTileBlock(ArcheonModElements instance) {
		super(instance, 140);
	}
