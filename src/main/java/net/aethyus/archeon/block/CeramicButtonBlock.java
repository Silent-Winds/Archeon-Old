...
public class CeramicButtonBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ceramic_button")
	public static final Block block = null;

	public CeramicButtonBlock(ArcheonModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("ceramic_button");
		}
