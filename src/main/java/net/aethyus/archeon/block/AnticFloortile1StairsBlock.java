...
public class AnticFloortile1StairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antic_floortile_1_stairs")
	public static final Block block = null;

	public AnticFloortile1StairsBlock(ArcheonModElements instance) {
		super(instance, 235);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("antic_floortile_1_stairs");
		}
