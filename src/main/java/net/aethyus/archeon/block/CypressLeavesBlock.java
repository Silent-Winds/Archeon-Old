...
public class CypressLeavesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cypress_leaves")
	public static final Block block = null;

	public CypressLeavesBlock(ArcheonModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cypress_leaves");
		}
