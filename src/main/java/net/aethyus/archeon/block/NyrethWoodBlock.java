...
public class NyrethWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nyreth_wood")
	public static final Block block = null;

	public NyrethWoodBlock(ArcheonModElements instance) {
		super(instance, 67);
	}
