...
public class RoughcastBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:roughcast")
	public static final Block block = null;

	public RoughcastBlock(ArcheonModElements instance) {
		super(instance, 233);
	}
