...
public class FancyChiseledArtemniteBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:fancy_chiseled_artemnite")
	public static final Block block = null;

	public FancyChiseledArtemniteBlock(ArcheonModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fancy_chiseled_artemnite");
		}
