...
public class DustBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dust")
	public static final Block block = null;

	public DustBlock(ArcheonModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("archeon:dust_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:dust"), configuredFeature);
		}
	}
