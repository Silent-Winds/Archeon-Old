...
public class AsterinPalmLeavesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:asterin_palm_leaves")
	public static final Block block = null;

	public AsterinPalmLeavesBlock(ArcheonModElements instance) {
		super(instance, 149);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("asterin_palm_leaves");
		}
