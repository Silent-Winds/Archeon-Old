...
public class AnticFloortileBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antic_floortile")
	public static final Block block = null;

	public AnticFloortileBlock(ArcheonModElements instance) {
		super(instance, 234);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("antic_floortile");
		}
