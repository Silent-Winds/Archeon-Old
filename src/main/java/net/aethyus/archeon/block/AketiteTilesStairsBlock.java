...
public class AketiteTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_tiles_stairs")
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("aketite_tiles_stairs");
		}
