...
public class DuneSandGlassTilesBottomLeftBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_tiles_bottom_left")
	public static final Block block = null;

	public DuneSandGlassTilesBottomLeftBlock(ArcheonModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_tiles_bottom_left");
		}
