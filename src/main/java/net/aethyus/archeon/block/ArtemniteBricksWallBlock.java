...
public class ArtemniteBricksWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_bricks_wall")
	public static final Block block = null;

	public ArtemniteBricksWallBlock(ArcheonModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("artemnite_bricks_wall");
		}
