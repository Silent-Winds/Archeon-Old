...
public class ArtemniteBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_bricks")
	public static final Block block = null;

	public ArtemniteBricksBlock(ArcheonModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("artemnite_bricks");
		}
