...
public class MossyArtemniteBricksSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_artemnite_bricks_slab")
	public static final Block block = null;

	public MossyArtemniteBricksSlabBlock(ArcheonModElements instance) {
		super(instance, 164);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_artemnite_bricks_slab");
		}
