...
public class IopeaBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:iopea")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("iopea"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:iopea"), configuredFeature);
		}
	}
