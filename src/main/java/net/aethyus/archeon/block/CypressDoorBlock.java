...
public class CypressDoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cypress_door")
	public static final Block block = null;

	public CypressDoorBlock(ArcheonModElements instance) {
		super(instance, 43);
	}
