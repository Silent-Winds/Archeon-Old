...
public class OchreTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ochre_tiles_stairs")
	public static final Block block = null;

	public OchreTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 288);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ochre_tiles_stairs");
		}
