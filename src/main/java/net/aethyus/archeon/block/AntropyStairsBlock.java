...
public class AntropyStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antropy_stairs")
	public static final Block block = null;

	public AntropyStairsBlock(ArcheonModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("antropy_stairs");
		}
