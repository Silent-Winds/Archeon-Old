...
public class DuneSandGlassPaneBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_pane")
	public static final Block block = null;

	public DuneSandGlassPaneBlock(ArcheonModElements instance) {
		super(instance, 256);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_pane");
		}
