...
public class ANTICfLOORTILEwALL2Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:anti_cf_loortil_ew_all_2")
	public static final Block block = null;

	public ANTICfLOORTILEwALL2Block(ArcheonModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("anti_cf_loortil_ew_all_2");
		}
