...
public class TropicstoneBricksSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_bricks_slab")
	public static final Block block = null;

	public TropicstoneBricksSlabBlock(ArcheonModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_bricks_slab");
		}
