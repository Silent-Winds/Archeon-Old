...
public class GypsumBricksFenceBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_bricks_fence")
	public static final Block block = null;

	public GypsumBricksFenceBlock(ArcheonModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_bricks_fence");
		}
