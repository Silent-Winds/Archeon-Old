...
public class CypressPressurePlateBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cypress_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("cypress_pressure_plate");
		}
