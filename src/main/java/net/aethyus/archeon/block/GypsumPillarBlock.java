...
public class GypsumPillarBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_pillar")
	public static final Block block = null;

	public GypsumPillarBlock(ArcheonModElements instance) {
		super(instance, 1318);
	}
