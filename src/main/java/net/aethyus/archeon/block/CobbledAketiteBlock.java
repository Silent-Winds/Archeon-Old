...
public class CobbledAketiteBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:cobbled_aketite")
	public static final Block block = null;

	public CobbledAketiteBlock(ArcheonModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobbled_aketite");
		}
