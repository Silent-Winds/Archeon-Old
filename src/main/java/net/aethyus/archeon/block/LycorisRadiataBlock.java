...
import net.aethyus.archeon.procedures.LycorisRadiataMobplayerCollidesWithPlantProcedure;
...
public class LycorisRadiataBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:lycoris_radiata")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lycoris_radiata"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:lycoris_radiata"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("lycoris_radiata");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A77Lycoris Squamigera Maxim"));
		}
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == WetGrassBlockBlock.block || ground == WetDirtBlock.block || ground == Blocks.DIRT || ground == Blocks.GRASS_BLOCK
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			LycorisRadiataMobplayerCollidesWithPlantProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
