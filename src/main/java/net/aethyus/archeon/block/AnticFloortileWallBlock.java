...
public class AnticFloortileWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antic_floortile_wall")
	public static final Block block = null;

	public AnticFloortileWallBlock(ArcheonModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("antic_floortile_wall");
		}
