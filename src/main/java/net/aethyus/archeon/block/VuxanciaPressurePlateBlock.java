...
public class VuxanciaPressurePlateBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vuxancia_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("vuxancia_pressure_plate");
		}
