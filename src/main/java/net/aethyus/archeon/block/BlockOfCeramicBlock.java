...
public class BlockOfCeramicBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:block_of_ceramic")
	public static final Block block = null;

	public BlockOfCeramicBlock(ArcheonModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("block_of_ceramic");
		}
