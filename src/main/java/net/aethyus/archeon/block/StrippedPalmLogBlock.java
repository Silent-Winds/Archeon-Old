...
public class StrippedPalmLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_palm_log")
	public static final Block block = null;

	public StrippedPalmLogBlock(ArcheonModElements instance) {
		super(instance, 142);
	}
