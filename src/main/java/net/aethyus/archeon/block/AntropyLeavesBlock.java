...
public class AntropyLeavesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antropy_leaves")
	public static final Block block = null;

	public AntropyLeavesBlock(ArcheonModElements instance) {
		super(instance, 150);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("antropy_leaves");
		}
