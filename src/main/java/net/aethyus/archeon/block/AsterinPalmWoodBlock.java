...
public class AsterinPalmWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:asterin_palm_wood")
	public static final Block block = null;

	public AsterinPalmWoodBlock(ArcheonModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("asterin_palm_wood");
		}
