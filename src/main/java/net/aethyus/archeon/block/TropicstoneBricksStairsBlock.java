...
public class TropicstoneBricksStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_bricks_stairs")
	public static final Block block = null;

	public TropicstoneBricksStairsBlock(ArcheonModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_bricks_stairs");
		}
