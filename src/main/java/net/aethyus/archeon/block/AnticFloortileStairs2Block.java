...
public class AnticFloortileStairs2Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antic_floortile_stairs_2")
	public static final Block block = null;

	public AnticFloortileStairs2Block(ArcheonModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("antic_floortile_stairs_2");
		}
