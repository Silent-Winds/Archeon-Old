...
public class DuneSandGlassTilesTopRightBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_tiles_top_right")
	public static final Block block = null;

	public DuneSandGlassTilesTopRightBlock(ArcheonModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_tiles_top_right");
		}
