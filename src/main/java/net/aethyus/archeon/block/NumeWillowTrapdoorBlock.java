...
public class NumeWillowTrapdoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_trapdoor")
	public static final Block block = null;

	public NumeWillowTrapdoorBlock(ArcheonModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("nume_willow_trapdoor");
		}
