...
public class WitheredOrangeLycorisBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:withered_orange_lycoris")
	public static final Block block = null;

	public WitheredOrangeLycorisBlock(ArcheonModElements instance) {
		super(instance, 216);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("withered_orange_lycoris"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:withered_orange_lycoris"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("withered_orange_lycoris");
		}
