...
public class PowerKeystoneBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:power_keystone")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(70f, 10f).setLightLevel(s -> 0));
			setRegistryName("power_keystone");
		}
