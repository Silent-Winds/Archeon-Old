...
public class GypsumTilesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_tiles")
	public static final Block block = null;

	public GypsumTilesBlock(ArcheonModElements instance) {
		super(instance, 1310);
	}
