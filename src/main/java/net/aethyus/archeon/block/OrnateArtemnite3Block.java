...
public class OrnateArtemnite3Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ornate_artemnite_3")
	public static final Block block = null;

	public OrnateArtemnite3Block(ArcheonModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ornate_artemnite_3");
		}
