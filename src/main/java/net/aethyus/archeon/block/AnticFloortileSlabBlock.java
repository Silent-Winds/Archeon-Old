...
public class AnticFloortileSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antic_floortile_slab")
	public static final Block block = null;

	public AnticFloortileSlabBlock(ArcheonModElements instance) {
		super(instance, 237);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("antic_floortile_slab");
		}
