...
public class RedTilesWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:red_tiles_wall")
	public static final Block block = null;

	public RedTilesWallBlock(ArcheonModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("red_tiles_wall");
		}
