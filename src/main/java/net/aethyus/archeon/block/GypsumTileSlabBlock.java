...
public class GypsumTileSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gypsum_tile_slab")
	public static final Block block = null;

	public GypsumTileSlabBlock(ArcheonModElements instance) {
		super(instance, 1312);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("gypsum_tile_slab");
		}
