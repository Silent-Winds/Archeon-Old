...
public class SummerAntropyTrapdoorBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:summer_antropy_trapdoor")
	public static final Block block = null;

	public SummerAntropyTrapdoorBlock(ArcheonModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("summer_antropy_trapdoor");
		}
