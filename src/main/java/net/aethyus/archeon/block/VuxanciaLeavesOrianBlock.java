...
public class VuxanciaLeavesOrianBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vuxancia_leaves_orian")
	public static final Block block = null;

	public VuxanciaLeavesOrianBlock(ArcheonModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vuxancia_leaves_orian");
		}
