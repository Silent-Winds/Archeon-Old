...
public class CeramicBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ceramic_bricks")
	public static final Block block = null;

	public CeramicBricksBlock(ArcheonModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("ceramic_bricks");
		}
