...
public class OchreTilesBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ochre_tiles")
	public static final Block block = null;

	public OchreTilesBlock(ArcheonModElements instance) {
		super(instance, 241);
	}
