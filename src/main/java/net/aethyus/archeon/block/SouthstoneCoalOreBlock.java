...
public class SouthstoneCoalOreBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:southstone_coal_ore")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("southstone_coal_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("archeon:southstone_coal_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("southstone_coal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:southstone_coal_ore"), configuredFeature);
		}
	}
