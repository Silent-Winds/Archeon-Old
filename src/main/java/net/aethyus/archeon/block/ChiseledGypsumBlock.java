...
public class ChiseledGypsumBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:chiseled_gypsum")
	public static final Block block = null;

	public ChiseledGypsumBlock(ArcheonModElements instance) {
		super(instance, 1319);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_gypsum");
		}
