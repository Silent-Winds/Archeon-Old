...
public class GreenTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:green_tiles_stairs")
	public static final Block block = null;

	public GreenTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 289);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_tiles_stairs");
		}
