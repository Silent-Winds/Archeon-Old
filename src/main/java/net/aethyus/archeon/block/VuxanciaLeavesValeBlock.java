...
public class VuxanciaLeavesValeBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vuxancia_leaves_vale")
	public static final Block block = null;

	public VuxanciaLeavesValeBlock(ArcheonModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vuxancia_leaves_vale");
		}
