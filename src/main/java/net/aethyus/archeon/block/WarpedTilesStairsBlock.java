...
public class WarpedTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:warped_tiles_stairs")
	public static final Block block = null;

	public WarpedTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_tiles_stairs");
		}
