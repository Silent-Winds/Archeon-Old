...
public class DuneSandGlassPaneTilesBottomLeftBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_pane_tiles_bottom_left")
	public static final Block block = null;

	public DuneSandGlassPaneTilesBottomLeftBlock(ArcheonModElements instance) {
		super(instance, 260);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_pane_tiles_bottom_left");
		}
