...
public class CraqueledAketiteBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:craqueled_aketite_bricks")
	public static final Block block = null;

	public CraqueledAketiteBricksBlock(ArcheonModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("craqueled_aketite_bricks");
		}
