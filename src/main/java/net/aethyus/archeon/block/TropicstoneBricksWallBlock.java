...
public class TropicstoneBricksWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:tropicstone_bricks_wall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("tropicstone_bricks_wall");
		}
