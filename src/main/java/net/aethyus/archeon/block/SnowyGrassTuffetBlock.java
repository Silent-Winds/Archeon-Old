...
public class SnowyGrassTuffetBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:snowy_grass_tuffet")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("snowy_grass_tuffet"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:snowy_grass_tuffet"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("snowy_grass_tuffet");
		}
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == PeaksSnowBlock.block || ground == SnowySouthstoneBlock.block || ground == PeaksGrassBlockBlock.block
