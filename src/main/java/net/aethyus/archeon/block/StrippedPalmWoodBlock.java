...
public class StrippedPalmWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_palm_wood")
	public static final Block block = null;

	public StrippedPalmWoodBlock(ArcheonModElements instance) {
		super(instance, 156);
	}
