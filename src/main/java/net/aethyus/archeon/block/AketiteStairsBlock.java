...
public class AketiteStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_stairs")
	public static final Block block = null;

	public AketiteStairsBlock(ArcheonModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).notSolid().setOpaque((bs, br, bp) -> false)).getDefaultState(),
			...
			setRegistryName("aketite_stairs");
		}
