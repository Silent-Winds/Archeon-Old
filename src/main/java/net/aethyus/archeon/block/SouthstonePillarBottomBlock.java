...
public class SouthstonePillarBottomBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:southstone_pillar_bottom")
	public static final Block block = null;

	public SouthstonePillarBottomBlock(ArcheonModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("southstone_pillar_bottom");
		}
