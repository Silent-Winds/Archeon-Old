...
public class AketiteWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_wall")
	public static final Block block = null;

	public AketiteWallBlock(ArcheonModElements instance) {
		super(instance, 93);
	}
