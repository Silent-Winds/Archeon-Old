...
public class RedTilesSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:red_tiles_slab")
	public static final Block block = null;

	public RedTilesSlabBlock(ArcheonModElements instance) {
		super(instance, 272);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("red_tiles_slab");
		}
