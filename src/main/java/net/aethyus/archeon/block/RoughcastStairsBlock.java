...
public class RoughcastStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:roughcast_stairs")
	public static final Block block = null;

	public RoughcastStairsBlock(ArcheonModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("roughcast_stairs");
		}
