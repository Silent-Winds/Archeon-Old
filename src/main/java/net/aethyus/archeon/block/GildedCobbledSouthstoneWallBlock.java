...
public class GildedCobbledSouthstoneWallBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:gilded_cobbled_southstone_wall")
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("gilded_cobbled_southstone_wall");
		}
