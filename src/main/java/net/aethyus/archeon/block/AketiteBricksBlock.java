...
public class AketiteBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_bricks")
	public static final Block block = null;

	public AketiteBricksBlock(ArcheonModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aketite_bricks");
		}
