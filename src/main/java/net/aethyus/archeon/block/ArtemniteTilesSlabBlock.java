...
public class ArtemniteTilesSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:artemnite_tiles_slab")
	public static final Block block = null;

	public ArtemniteTilesSlabBlock(ArcheonModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("artemnite_tiles_slab");
		}
