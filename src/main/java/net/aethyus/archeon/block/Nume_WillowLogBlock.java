...
public class Nume_WillowLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:nume_willow_log")
	public static final Block block = null;

	public Nume_WillowLogBlock(ArcheonModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("nume_willow_log");
		}
