...
public class StrippedVuxanciaLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_vuxancia_log")
	public static final Block block = null;

	public StrippedVuxanciaLogBlock(ArcheonModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_vuxancia_log");
		}
