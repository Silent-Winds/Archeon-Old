...
public class MossyArtemniteBricksBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:mossy_artemnite_bricks")
	public static final Block block = null;

	public MossyArtemniteBricksBlock(ArcheonModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mossy_artemnite_bricks");
		}
