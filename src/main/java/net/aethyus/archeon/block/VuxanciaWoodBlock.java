...
public class VuxanciaWoodBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vuxancia_wood")
	public static final Block block = null;

	public VuxanciaWoodBlock(ArcheonModElements instance) {
		super(instance, 43);
	}
