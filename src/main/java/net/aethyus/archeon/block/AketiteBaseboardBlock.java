...
public class AketiteBaseboardBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_baseboard")
	public static final Block block = null;

	public AketiteBaseboardBlock(ArcheonModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aketite_baseboard");
		}
