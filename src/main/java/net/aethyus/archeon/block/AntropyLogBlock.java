...
public class AntropyLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antropy_log")
	public static final Block block = null;

	public AntropyLogBlock(ArcheonModElements instance) {
		super(instance, 23);
	}
