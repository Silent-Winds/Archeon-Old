...
public class OrnateAketite2Block extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:ornate_aketite_2")
	public static final Block block = null;

	public OrnateAketite2Block(ArcheonModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ornate_aketite_2");
		}
