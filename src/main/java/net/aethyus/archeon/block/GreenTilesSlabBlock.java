...
public class GreenTilesSlabBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:green_tiles_slab")
	public static final Block block = null;

	public GreenTilesSlabBlock(ArcheonModElements instance) {
		super(instance, 251);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("green_tiles_slab");
		}
