...
public class AntropyPressurePlateBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:antropy_pressure_plate")
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("antropy_pressure_plate");
		}
