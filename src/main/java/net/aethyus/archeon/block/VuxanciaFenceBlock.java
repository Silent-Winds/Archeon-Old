...
public class VuxanciaFenceBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:vuxancia_fence")
	public static final Block block = null;

	public VuxanciaFenceBlock(ArcheonModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("vuxancia_fence");
		}
