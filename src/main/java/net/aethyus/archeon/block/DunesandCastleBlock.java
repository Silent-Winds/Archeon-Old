...
public class DunesandCastleBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dunesand_castle")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TropicalSandBlock.block));
		}
	}
}
