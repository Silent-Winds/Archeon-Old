...
public class DuneSandGlassPaneTilesBottomRightBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:dune_sand_glass_pane_tiles_bottom_right")
	public static final Block block = null;

	public DuneSandGlassPaneTilesBottomRightBlock(ArcheonModElements instance) {
		super(instance, 257);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dune_sand_glass_pane_tiles_bottom_right");
		}
