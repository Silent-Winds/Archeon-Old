...
public class AketiteBrickStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:aketite_brick_stairs")
	public static final Block block = null;

	public AketiteBrickStairsBlock(ArcheonModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("aketite_brick_stairs");
		}
