...
public class WetFernBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:wet_fern")
	public static final Block block = null;

	public WetFernBlock(ArcheonModElements instance) {
		super(instance, 236);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("wet_fern"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("archeon:wet_fern"), configuredFeature);
		}
	}
