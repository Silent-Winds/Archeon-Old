...
public class StrippedCypressLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:stripped_cypress_log")
	public static final Block block = null;

	public StrippedCypressLogBlock(ArcheonModElements instance) {
		super(instance, 125);
	}
