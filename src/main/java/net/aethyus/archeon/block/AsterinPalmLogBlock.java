...
public class AsterinPalmLogBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:asterin_palm_log")
	public static final Block block = null;

	public AsterinPalmLogBlock(ArcheonModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("asterin_palm_log");
		}
