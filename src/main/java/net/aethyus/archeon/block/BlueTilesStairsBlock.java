...
public class BlueTilesStairsBlock extends ArcheonModElements.ModElement {
	@ObjectHolder("archeon:blue_tiles_stairs")
	public static final Block block = null;

	public BlueTilesStairsBlock(ArcheonModElements instance) {
		super(instance, 292);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_tiles_stairs");
		}
