...
import net.aethyus.archeon.particle.AzureButterflyParticle;
...
import net.aethyus.archeon.block.CypressLeavesBlock;
import net.aethyus.archeon.ArcheonModElements;

@ArcheonModElements.ModElement.Tag
public class SouthMeadowsBiome extends ArcheonModElements.ModElement {
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-14892886).setWaterFogColor(329011)
						...
						.setMoodSound(new MoodSoundAmbience(
								...
								1500, 8, 2))
						.setParticle(new ParticleEffectAmbience(AzureButterflyParticle.particle, 0.003f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(CypressLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(CypressLeavesBlock.block.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(HeiferEntity.entity, 18, 2, 4));
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.HORSE, 18, 2, 4));
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.PIG, 18, 2, 4));
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.CHICKEN, 18, 2, 4));
				...
				event.getRegistry().register(biome.setRegistryName("archeon:south_meadows"));
			}
		}
	}
