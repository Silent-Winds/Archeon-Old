...
import net.aethyus.archeon.block.SaltBlockBlock;
import net.aethyus.archeon.block.AntropyLogBlock;
import net.aethyus.archeon.block.AntropyLeavesBlock;
import net.aethyus.archeon.ArcheonModElements;

@ArcheonModElements.ModElement.Tag
public class TropicalOceanBiome extends ArcheonModElements.ModElement {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-14892886).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-9399763).withGrassColor(-9399763)
						.setMoodSound(new MoodSoundAmbience(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("archeon:brile")), 3000, 8,
								2))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(TropicalSandBlock.block.getDefaultState(),
								Blocks.SAND.getDefaultState(), SaltBlockBlock.block.getDefaultState())));
				...
				mobSpawnInfo.withSpawner(EntityClassification.AMBIENT, new MobSpawnInfo.Spawners(AuroraCatalystEntity.entity, 3, 1, 2));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.COD, 5, 3, 5));
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.TROPICAL_FISH, 5, 3, 5));
