...
import net.aethyus.archeon.procedures.ExplosiveAuroraCatalystPlayerCollidesWithThisEntityProcedure;
import net.aethyus.archeon.itemgroup.ArcheonMiscItemGroup;
import net.aethyus.archeon.entity.renderer.ExplosiveAuroraCatalystRenderer;
...
public class ExplosiveAuroraCatalystEntity extends ArcheonModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4497478, -9810132, new Item.Properties().group(ArcheonMiscItemGroup.tab))
				.setRegistryName("explosive_aurora_catalyst_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			ExplosiveAuroraCatalystPlayerCollidesWithThisEntityProcedure.executeProcedure(Stream
