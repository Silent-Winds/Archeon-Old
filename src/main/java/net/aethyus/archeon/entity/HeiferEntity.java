...
import net.aethyus.archeon.entity.renderer.HeiferRenderer;
...
public class HeiferEntity extends ArcheonModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14478842, -13097203, new Item.Properties().group(ArcheonMiscItemGroup.tab))
				.setRegistryName("heifer_spawn_egg"));
	}
	...
	public static class CustomEntity extends CowEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RawHeiferItem.block));
		}
