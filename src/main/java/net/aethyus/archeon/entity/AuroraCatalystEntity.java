...
import net.aethyus.archeon.entity.renderer.AuroraCatalystRenderer;
...
public class AuroraCatalystEntity extends ArcheonModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12396568, -12900543, new Item.Properties().group(ArcheonMiscItemGroup.tab))
				.setRegistryName("aurora_catalyst_spawn_egg"));
	}
