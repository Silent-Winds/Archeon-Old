...
public class DeerEntity extends ArcheonModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -5208227, -1184791, new Item.Properties().group(ArcheonMiscItemGroup.tab))
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (RawHeiferItem.block == stack.getItem())
				return true;
			if (BloodOrangeItem.block == stack.getItem())
				return true;
