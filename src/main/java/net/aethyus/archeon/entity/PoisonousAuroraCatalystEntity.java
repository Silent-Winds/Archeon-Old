...
package net.aethyus.archeon.entity;
...
import net.aethyus.archeon.procedures.PoisonousAuroraCatalystPlayerCollidesWithThisEntityProcedure;
import net.aethyus.archeon.itemgroup.ArcheonMiscItemGroup;
import net.aethyus.archeon.entity.renderer.PoisonousAuroraCatalystRenderer;
...
public class PoisonousAuroraCatalystEntity extends ArcheonModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11438557, -10144140, new Item.Properties().group(ArcheonMiscItemGroup.tab))
				.setRegistryName("poisonous_aurora_catalyst_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("archeon:catalyst.ambient"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("archeon:catalyst.hit"));
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			PoisonousAuroraCatalystPlayerCollidesWithThisEntityProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
